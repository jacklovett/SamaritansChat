...
var routes = [
    // TODO: Try to add AdminGuard similar to how we use AuthGuard
    { path: '', component: _users_users_component__WEBPACK_IMPORTED_MODULE_5__["UsersComponent"], canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_4__["AuthGuard"]] },
    { path: 'chat', component: _chat_chat_component__WEBPACK_IMPORTED_MODULE_1__["ChatComponent"], canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_4__["AuthGuard"]] },
...
module.exports = "<nav class=\"navbar navbar-expand navbar-dark bg-dark\" *ngIf=\"currentUser\">\n  <div class=\"navbar-nav\">\n      <a class=\"nav-item nav-link\" *ngIf=\"admin\" routerLink=\"/\">Users</a>\n      <a class=\"nav-item nav-link\" routerLink=\"/chat\">Chat</a>\n      <a class=\"nav-item nav-link\" (click)=\"logout()\">Logout</a>\n  </div>\n</nav>\n\n<!-- main app container -->\n<div class=\"container\">\n    <div class=\"row\">\n        <div class=\"col-sm-6 offset-sm-3\">\n            <app-alert></app-alert>\n            <router-outlet></router-outlet>\n        </div>\n    </div>\n</div>\n"
...
var AppComponent = /** @class */ (function () {
    function AppComponent(router, adminGuard, authenticationService) {
        this.router = router;
    ...
    AppComponent.prototype.ngOnInit = function () {
        ...
        this.admin = this.adminGuard.checkIsAdmin();
    };
    ...
    AppComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({ selector: 'app-root',
            template: __webpack_require__(/*! ./app.component.html */ "./src/app/app.component.html"), styles: [__webpack_require__(/*! ./app.component.scss */ "./src/app/app.component.scss")] }),
...
/* harmony import */ var _helpers_error_interceptor__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./helpers/error.interceptor */ "./src/app/helpers/error.interceptor.ts");
/* harmony import */ var _helpers_jwt_interceptor__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./helpers/jwt.interceptor */ "./src/app/helpers/jwt.interceptor.ts");
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [
                { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HTTP_INTERCEPTORS"], useClass: _helpers_jwt_interceptor__WEBPACK_IMPORTED_MODULE_15__["JwtInterceptor"], multi: true },
...
var AdminGuard = /** @class */ (function () {
    function AdminGuard(authenticationService) {
        this.authenticationService = authenticationService;
        this.admin = false;
    }
    AdminGuard.prototype.checkIsAdmin = function () {
        ...
        if (currentUser) {
            var jwt = currentUser.token;
            if (typeof jwt === undefined) {
                console.log('No token found');
            }
            var jwtData = jwt.split('.')[1];
            var decodedJwtData = JSON.parse(window.atob(jwtData));
            var sub = JSON.parse(decodedJwtData.sub);
            this.admin = sub.admin;
        }
        return this.admin;
    };
...
module.exports = ".login-panel {\n  margin: 100px 0; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(formBuilder, route, router, authenticationService, alertService, adminGuard, appComponent) {
    ...
    LoginComponent.prototype.handleRedirect = function () {
        if (this.adminGuard.checkIsAdmin()) {
    ...
    LoginComponent.prototype.onSubmit = function () {
        ...
        this.authenticationService
            ...
            _this.appComponent.ngOnInit(); // refresh appComponent to ensure admin property is set correctly
    ...
    LoginComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormBuilder"],
            ...
            _guards_admin_guard__WEBPACK_IMPORTED_MODULE_5__["AdminGuard"],
    ...
    MaterialModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            imports: [
                ...
                _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatTableDataSource"]
            ],
            exports: [
                _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatButtonModule"],
                _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatMenuModule"],
...
var AuthenticationService = /** @class */ (function () {
    ...
    AuthenticationService.prototype.login = function (usernameOrEmail, password) {
        var _this = this;
        return this.http.post(this.apiUrl + "/auth/login", { usernameOrEmail: usernameOrEmail, password: password })
...
var UsersComponent = /** @class */ (function () {
    ...
    UsersComponent.prototype.deleteUser = function (id) {
        ...
        this.userService.delete(id)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["first"])()).subscribe(function () {
            _this.loadUsers();
        });
    };
    ...
    UsersComponent.prototype.loadUsers = function () {
        ...
        this.userService.get()
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["first"])()).subscribe(function (users) {
            _this.users = users;
        });
    };
...
module.exports = __webpack_require__(/*! C:\dev\projects\GitHub\GibSams\gibsamsprivate\src\main.ts */"./src/main.ts");
